...
class Char_Segmention_Loss_Attn_Attn_KL(nn.Module):
    def __init__(self):
        ...
        weight = torch.Tensor([1.000,
                               1.000, 1.013, 1.058, 1.323, 1.564, 1.831, 2.210, 2.859, 3.978, 5.959,
                               5.959, 3.978, 2.859, 2.210, 1.831, 1.564, 1.323, 1.058, 1.013, 1.000,
...
class STR_Loss(nn.Module):
    ...
    def forward(self, masks, backfore_feature, seq1_attention_map, char_feature_attn, length, iteration, alpha):
        ...
        return (predmask_loss, Correct_loss, Mutual_exclusion_loss), Single_char_mask, fore_mask