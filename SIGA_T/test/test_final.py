...
def validation(model, criterion, evaluation_loader, converter, opt):
    ...
    for i, (image_tensors, masks, labels, imgs_path) in enumerate(evaluation_loader):
        ...
        if opt.Transformer in ["mgp-str"]:
            ...
            Ours_pred, TRBA_pred, (pre2D_iter1, pre2D_iter2), (Iter_pred1, Iter_pred2), Share_pred = model(image, None, target, None, None, is_eval=True) # final
            ...
            gly_preds_str, gly_preds_max_prob = decode(pre2D_iter1, converter, batch_size)
    ...
    return valid_loss_avg.val(), [char_accuracy, gly_accuracy, Iter_accuracy, final_accuracy, out_accuracy], char_preds_str, confidence_score_list, labels, infer_time, length_of_data, [char_n_correct, gly_n_correct, Iter_n_correct, final_n_correct, out_n_correct]
